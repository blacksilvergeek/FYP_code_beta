...
def adam_optimize(objective, params, jac, step_size=1e-2, Nsteps=100, bounds=None, direction='min', beta1=0.9, beta2=0.999, callback=None, verbose=True,th=None):
    ...
    if th!=None:
        ...
        for iteration in range(Nsteps):
            ...
            if verbose:
                print("Epoch: %3d/%3d | Duration: %.2f secs | Value: %5e | loss_diff: %5e" %(iteration+1, Nsteps, t_elapsed, of_list[-1],th0))
